...
if($accion == "mod6_insertar"){	
				...
				if (!copy($_FILES['foto_extra'.$i]['tmp_name'], $foto_extra_ruta_grande . $foto)){ //si hay error en la copia de la foto
					...
					if($imagesize[2]>0 && $imagesize[2]<=16){ //si es una imagen
						...
						if($peso==0){
							...
							VALUES 
							('$idproducto','$foto', '$foto_extra_titulo_row[$i]', '$foto_extra_tipo', '$foto_extra_ididioma[$c]', '$foto_extra_orden_row[$i]')";
	...
	echo "<script>window.location.href=('".$_SERVER['PHP_SELF']."?idproducto=".$idproducto."');</script>";
	
};		

	$query_producto = "SELECT titulo 
	FROM producto_idioma_dato
	WHERE idproducto = '$idproducto' AND ididioma = 1";
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="12" class="fondo_tabla_principal">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" valign="bottom" class="titulo_grande_bold">Producto - Carga Multiple de Fotos Extra </td>
              </tr>
              <tr>
                <td height="20" valign="top" class="detalle_medio"><hr size="1" noshade="noshade" style="color:#CCCCCC;" />
                &nbsp; <?= $idproducto.". ".$rs_producto['titulo'] ?><br /><br />
</td>
              </tr>
            </table>
...
?>
                      ...
                      <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                        <tr bgcolor="#999999">
                          <td height="35" bgcolor="#FF8282" class="titulo_medio_bold">Fotos extras  del producto:</td>
                        </tr>
                        <tr bgcolor="#999999">
						...
						while($rs_foto = mysql_fetch_assoc($result_foto)){
							 ...
							 ?>
                                <td align="center" valign="top" class="ejemplo_12px"><table width="150" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFBBBB">
                                    <tr>
                                      <td height="30" bgcolor="#FFBBBB" style="border: 1px solid #FFBBBB;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      <td align="center" valign="middle" bgcolor="#FFBBBB" style="border: 1px solid #FFBBBB;"><?
										if($rs_foto['foto'] == ''){
                                    ...
                                    <tr>
                                      <td height="28" align="left" bgcolor="#FFBBBB" class="detalle_medio" style="border: 1px solid #FFBBBB;">&nbsp; <?= $rs_foto['titulo']; ?></td>
                                    </tr>
                                    <tr>
                                      <td height="28" align="left" bgcolor="#FFBBBB" class="detalle_chico" style="border: 1px solid #FFBBBB;">&nbsp; N&ordm; de Orden: <?= $rs_foto['orden'] ?></td>
                                    </tr>
                                </table></td>
                                <?	
								if($vuelta_foto == 4){ 
