<? 
	...
	function cambiar_estado_hab($estado, $iduser_web){
		
		$query_estado = "UPDATE user_web SET estado = '$estado'
		WHERE iduser_web = '$iduser_web'
		LIMIT 1 ";
		mysql_query($query_estado);
		$codigo = '<img src="../../imagen/b_habilitado.png" alt="Habilitado" width="15" height="16" border="0" />
		<img src="../../imagen/b_confirmar_off.png" onclick="xajax_cambiar_estado_sin(3,'.$iduser_web.');" alt="A Confirmar" width="15" height="16" border="0" />
		<img src="../../imagen/b_deshabilitado_off.png" onclick="xajax_cambiar_estado_des(2,'.$iduser_web.');" alt="Deshabilitado" width="15" height="16" border="0" />';
		
		$response = new xajaxResponse();
		$response->call("actualizar_estado", $iduser_web, $codigo);
		return $response;
	};
	
	function cambiar_estado_sin($estado, $iduser_web){
		...
		$codigo = '<img src="../../imagen/b_habilitado_off.png" onclick="xajax_cambiar_estado_hab(1,'.$iduser_web.');" alt="Habilitado" width="15" height="16" border="0" />
		<img src="../../imagen/b_confirmar.png" alt="A Confirmar" width="15" height="16" border="0" />
		<img src="../../imagen/b_deshabilitado_off.png" onclick="xajax_cambiar_estado_des(2,'.$iduser_web.');" alt="Deshabilitado" width="15" height="16" border="0" />';
	...
	function cambiar_estado_des($estado, $iduser_web){
		...
		$codigo = '<img src="../../imagen/b_habilitado_off.png" onclick="xajax_cambiar_estado_hab(1,'.$iduser_web.');" alt="Habilitado" width="15" height="16" border="0" />
		<img src="../../imagen/b_confirmar_off.png" onclick="xajax_cambiar_estado_sin(3,'.$iduser_web.');"  alt="A Confirmar" width="15" height="16" border="0" />
		<img src="../../imagen/b_deshabilitado.png" alt="Deshabilitado" width="15" height="16" border="0" />';
	...
	$xajax->registerFunction("cambiar_estado_hab");
	$xajax->registerFunction("cambiar_estado_sin");
	$xajax->registerFunction("cambiar_estado_des");
...
<script language="javascript">
	...
	function actualizar_estado(div, codigo){
		xajax.$('estado' + div).innerHTML = codigo;
	}
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="12" class="fondo_tabla_principal">
                  ...
                  <td align="right"><form method="post" name="form_lista" id="form_lista">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                        <tr bgcolor="#ffddbc">
                          ...
                          <td width="18%" height="40" align="left" valign="middle" class="detalle_medio_bold">Propiedades</td>
                        </tr>
        <?
		...
		?>
                        <tr valign="middle" bgcolor="<?=$colores[$cont_colores]?>" class="detalle_medio">
                          ...
                          <td align="left" valign="middle" bgcolor="<?=$colores[$cont_colores]?>" class="detalle_medio"><div style="width:60px; overflow:hidden; height:16px; float:left;" id="estado<?=$rs_lista['iduser_web']?>"><? if($rs_lista['estado'] == 1){ ?> <img src="../../imagen/b_habilitado.png" alt="Habilitado" width="15" height="16" border="0" />
                            <? }else{ ?>
                            <img src="../../imagen/b_habilitado_off.png" alt="Habilitado" width="15" height="16" border="0" onclick="xajax_cambiar_estado_hab(1,<?=$rs_lista['iduser_web']?>);" />
                            <? } ?>
							<? if($rs_lista['estado'] == 3){ ?> <img src="../../imagen/b_confirmar.png" alt="A Confirmar" width="15" height="16" border="0" />
							<? }else{ ?>
							<img src="../../imagen/b_confirmar_off.png" onclick="xajax_cambiar_estado_sin(3,<?=$rs_lista['iduser_web']?>);" alt="A Confirmar" width="15" height="16" border="0" />
							<? } ?><? if($rs_lista['estado'] == 2){ ?> <img src="../../imagen/b_deshabilitado.png" alt="Habilitado" width="15" height="16" border="0" />
							<? }else{ ?>
							<img src="../../imagen/b_deshabilitado_off.png" onclick="xajax_cambiar_estado_des(2,<?=$rs_lista['iduser_web']?>);" alt="Deshabilitado" width="15" height="16" border="0" />
							<? } ?></div>
