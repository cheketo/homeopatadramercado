<? 
	...
	if($accion == "insertar"){			
		...
		$query_ingreso = "INSERT INTO admin_opcion (
		  titulo
		, idadmin_menu
		) VALUES (
		  '$titulo'
		...
		$query_max = "SELECT MAX(idadmin_opcion) AS idadmin_opcion FROM admin_opcion";
		...
		, iduser_admin_perfil 
		  ...
		  '$rs_max[idadmin_opcion]'
		, '1'
		)";
		mysql_query($query_ingreso);		
		
		// ABRIR VENTANA EDITAR CATEGORIA:		
		echo "<script>window.location.href('admin_opcion_editar.php?idadmin_opcion=".$rs_max['idadmin_opcion']."');</script>";
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="12" class="fondo_tabla_principal">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" valign="bottom" class="titulo_grande_bold">Menu Iconos Admin Opciones     - Nueva</td>
              </tr>
              <tr>
                ...
                <tr>
                  <td><form action="" method="post" name="form" id="form">
                      <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                        <tr bgcolor="#999999">
                          <td height="40" bgcolor="#FFDDBC" class="titulo_medio_bold">Ingrese el t&iacute;tulo de la nueva opci&oacute;n para su Icono:<span class="detalle_chico" style="color:#FF0000">
                        ...
                        <tr bgcolor="#999999">
                          <td bgcolor="#FFF0E1"><table width="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
                              ...
                              <tr>
                                <td width="90" valign="top" class="detalle_medio">&nbsp;</td>
