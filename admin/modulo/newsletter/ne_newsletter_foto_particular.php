...
<? 
	...
	if($accion == "eliminar_foto"){	
		...
		$query_sel = "SELECT foto FROM ne_foto WHERE idne_foto = '$eliminar' AND idne_newsletter = '$idne_newsletter'";
		...
		$query_del = "DELETE FROM ne_foto WHERE idne_foto = '$eliminar' AND idne_newsletter = '$idne_newsletter'";
	...
	if($accion == "mod6_insertar"){	
		...
		for ($i=1; $i<=$cont_producto ; $i++){
			...
			if ($_FILES['foto_extra'.$i]['name'] != ''){
				...
				$foto = $idne_newsletter. '-' . rand(0,999) . '-' . $archivo; //se captura el nombre del archivo de la foto			
				...
				if (!copy($_FILES['foto_extra'.$i]['tmp_name'], $foto_newsletter_ruta . $foto)){ //si hay error en la copia de la foto
					...
					if($imagesize[2]>0 && $imagesize[2]<=16){ //si es una imagen
						...
						if($peso==0){
							...
							(foto, idne_newsletter, nombre, estado) 
							VALUES 
							('$foto', '$idne_newsletter', '$foto_extra_titulo_row[$i]','1')";
	  ...
	  <table width="100%" border="0" cellpadding="0" cellspacing="12" class="fondo_tabla_principal">
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td height="40" valign="bottom" class="titulo_grande_bold">Newsletter - Galer&iacute;a de Im&aacute;genes </td>
              </tr>
              <tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="detalle_medio">
                <tr>
                  <td><form action="" method="post" enctype="multipart/form-data" name="frm" id="frm">
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                      <tr bgcolor="#999999">
                        <td height="35" bgcolor="#FF8282" class="titulo_medio_bold">Galer&iacute;a de Fotos:
                        <input name="eliminar" type="hidden" id="eliminar" /></td>
                      </tr>
                      <tr bgcolor="#999999">
                        <td align="center" bgcolor="#FFE1E1"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                          <tr>
				...
				?>
                                    ...
                                    <tr>
                                      <td height="30" bgcolor="#FFBBBB"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr valign="middle" class="detalle_medio">
                                            <td align="right"><a href="javascript:eliminar_foto(<?=$rs_foto['idne_foto']?>);"><img src="../../imagen/cruz.png" width="16" height="16" border="0" /></a></td>
                                          </tr>
                                      </table></td>
                                    </tr>
                                    <tr>
                                      <td align="center" valign="middle" bgcolor="#FFBBBB"><?
											$foto_extra =& new obj0001('0',$foto_newsletter_ruta,$rs_foto['foto'],'150','','','',$foto_newsletter_ruta.$rs_foto['foto'],'_blank','','',''); 
										?></td>
                                    </tr>
                                    <tr>
                                      <td height="28" align="left" bgcolor="#FFBBBB" class="detalle_medio" >&nbsp;
                                          <?= $rs_foto['nombre']; ?></td>
                                    </tr>
                                </table></td>
                                <?	
                      ...
                      <tr bgcolor="#999999">
                        <td align="left" valign="middle" bgcolor="#FFE1E1" class="detalle_medio" height="0"><span><? echo paginar($pag, $cantidad_total, $cantidad_registros, $_SERVER['PHP_SELF']."?cant=".$cantidad_registros."&pag=" ); ?></span></td>
                      </tr>
                    </table>
                    <br />
                    <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
                      <tr bgcolor="#999999">
                        <td height="40" bgcolor="#FF8282" class="titulo_medio_bold">Propiedades de las im&aacute;genes:<span class="detalle_chico" style="color:#FF0000">
